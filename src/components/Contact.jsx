  ...
  return (
    <div name='Contact' className='w-full h-screen primary-bg flex justify-center items-center p-4'>
        <form method='POST' action="https://submit-form.com/fjqdLiZg" className='flex flex-col max-w-[600px] w-full'>
            ...
            <input className='bg-[#ccd6f6] p-2' type="text"  placeholder='Name or Organization' name='name' required />
            ...
            <button type='submit' className='text-white border-2 hover:bg-[#f7ccac] hover:border-[#f7ccac] hover:text-gray-900 px-4 py-3 my-8 mx-auto flex items-center'>Send</button>
        </form>        
    </div>
